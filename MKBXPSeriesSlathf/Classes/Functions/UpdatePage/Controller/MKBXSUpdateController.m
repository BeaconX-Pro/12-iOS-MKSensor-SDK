...
@interface MKBXSUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBXSDFUModule *dfuModule;
...
@implementation MKBXSUpdateController

- (void)dealloc {
    NSLog(@"MKBXSUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bxs_startDfuProcessNotification" object:nil];
...
- (MKBXSDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKBXSDFUModule alloc] init];
    }
    return _dfuModule;
}
