...
@implementation MKBXSTHSensorHeaderViewModel
@end


@interface MKBXSHTConfigValueView : UIView
...
@implementation MKBXSHTConfigValueView
...
@interface MKBXSTHSensorHeaderView ()

@property (nonatomic, strong)UIView *backView;

@property (nonatomic, strong)UILabel *msgLabel;

@property (nonatomic, strong)MKBXSHTConfigValueView *tempView;

@property (nonatomic, strong)MKBXSHTConfigValueView *humidityView;
...
@implementation MKBXSTHSensorHeaderView
...
#pragma mark - setter
- (void)setDataModel:(MKBXSTHSensorHeaderViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBXSTHSensorHeaderViewModel.class]) {
        return;
    }
    self.tempView.valueLabel.text = SafeStr(_dataModel.temperature);
    self.humidityView.valueLabel.text = SafeStr(_dataModel.humidity);
...
- (MKBXSHTConfigValueView *)tempView {
    if (!_tempView) {
        _tempView = [[MKBXSHTConfigValueView alloc] init];
        _tempView.leftIcon.image = LOADICON(@"MKBXPSeriesSlathf", @"MKBXSTHSensorHeaderView", @"bxs_slotConfig_temperatureIcon.png");
...
- (MKBXSHTConfigValueView *)humidityView {
    if (!_humidityView) {
        _humidityView = [[MKBXSHTConfigValueView alloc] init];
        _humidityView.leftIcon.image = LOADICON(@"MKBXPSeriesSlathf", @"MKBXSTHSensorHeaderView", @"bxs_slotConfig_humidityIcon.png");
