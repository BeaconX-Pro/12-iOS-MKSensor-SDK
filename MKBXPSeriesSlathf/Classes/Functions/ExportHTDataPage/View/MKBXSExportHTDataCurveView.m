...
@interface MKBXSExportHTDataCurveView ()
...
@property (nonatomic, strong)MKBXSTHCurveView *humidityView;

@property (nonatomic, strong)MKBXSTHCurveViewModel *humidityModel;

@end

@implementation MKBXSExportHTDataCurveView
...
- (MKBXSTHCurveView *)humidityView {
    if (!_humidityView) {
        _humidityView = [[MKBXSTHCurveView alloc] init];
    }
    return _humidityView;
}

- (MKBXSTHCurveViewModel *)humidityModel {
    if (!_humidityModel) {
        _humidityModel = [[MKBXSTHCurveViewModel alloc] init];
