...
@interface MKBXSAboutController ()
...
@implementation MKBXSAboutController

- (void)dealloc {
    NSLog(@"MKBXSAboutController销毁");
}
...
- (void)loadSubViews {
    ...
    UIImage *image = LOADICON(@"MKBXPSeriesSlathf", @"MKBXSScanController", @"bxs_aboutBottomIcon.png");
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKBXPSeriesSlathf", @"MKBXSScanController", @"bxs_about_logo.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKBXPSeriesSlathf", @"MKBXSScanController", @"bxs_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
