...
@interface MKBXSDeviceInfoModel ()
...
@implementation MKBXSDeviceInfoModel
...
- (BOOL)readMacAddress {
    ...
    [MKBXSInterface bxs_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readBatteryVoltage {
    __block BOOL success = NO;
    [MKBXSInterface bxs_readBatteryVoltageWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readBatteryPercent {
    __block BOOL success = NO;
    [MKBXSInterface bxs_readBatteryPercentageWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
        self.batteryPercent = returnData[@"result"][@"percentage"];
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
    }];
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKBXSInterface bxs_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKBXSInterface bxs_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKBXSInterface bxs_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKBXSInterface bxs_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKBXSInterface bxs_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManuDate {
    __block BOOL success = NO;
    [MKBXSInterface bxs_readProductionDateWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
