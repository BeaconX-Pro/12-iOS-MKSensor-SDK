...
@interface MKBXSDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBXSDeviceInfoModel *dataModel;

@end

@implementation MKBXSDeviceInfoController
...
- (void)updateCellModels {
    ...
    cellModel2.rightMsg = [self.dataModel.batteryPercent stringByAppendingString:@"%"];
    
    MKNormalTextCellModel *cellModel3 = self.dataList[2];
    cellModel3.rightMsg = SafeStr(self.dataModel.macAddress);
    
    MKNormalTextCellModel *cellModel4 = self.dataList[3];
    cellModel4.rightMsg = SafeStr(self.dataModel.productMode);
    
    MKNormalTextCellModel *cellModel5 = self.dataList[4];
    cellModel5.rightMsg = SafeStr(self.dataModel.software);
    
    MKNormalTextCellModel *cellModel6 = self.dataList[5];
    cellModel6.rightMsg = SafeStr(self.dataModel.firmware);
    
    MKNormalTextCellModel *cellModel7 = self.dataList[6];
    cellModel7.rightMsg = SafeStr(self.dataModel.hardware);
    
    MKNormalTextCellModel *cellModel8 = self.dataList[7];
    cellModel8.rightMsg = SafeStr(self.dataModel.manuDate);
    
    MKNormalTextCellModel *cellModel9 = self.dataList[8];
    cellModel9.rightMsg = SafeStr(self.dataModel.manu);
...
- (void)loadSectionDatas {
    ...
    cellModel2.leftMsg = @"Battery Percentage";
    ...
    cellModel4.leftMsg = @"Product model";
...
- (MKBXSDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBXSDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
