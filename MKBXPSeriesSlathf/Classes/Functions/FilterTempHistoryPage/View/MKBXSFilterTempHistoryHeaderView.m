//
//  MKBXSFilterTempHistoryHeaderView.m
...
@interface MKBXSFilterTempHistoryHeaderView ()
...
@implementation MKBXSFilterTempHistoryHeaderView
...
- (void)switchButtonPressed {
    ...
    UIImage *icon = (self.switchButton.selected ? LOADICON(@"MKBXPSeriesSlathf", @"MKBXSFilterTempHistoryHeaderView", @"bxs_exportHT_curveSelected.png") : LOADICON(@"MKBXPSeriesSlathf", @"MKBXSFilterTempHistoryHeaderView", @"bxs_exportHT_tableSelected.png"));
...
- (UIButton *)switchButton {
    if (!_switchButton) {
        ...
        [_switchButton setImage:LOADICON(@"MKBXPSeriesSlathf", @"MKBXSFilterTempHistoryHeaderView", @"bxs_exportHT_tableSelected.png") forState:UIControlStateNormal];
...
- (UIButton *)exportButton {
    if (!_exportButton) {
        ...
        [_exportButton setImage:LOADICON(@"MKBXPSeriesSlathf", @"MKBXSFilterTempHistoryHeaderView", @"bxs_slotExportEnableIcon.png") forState:UIControlStateNormal];
