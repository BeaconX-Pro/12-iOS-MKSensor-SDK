...
@interface MKBXSScanDeviceInfoCell ()
...
@implementation MKBXSScanDeviceInfoCell

+ (MKBXSScanDeviceInfoCell *)initCellWithTableView:(UITableView *)tableView{
    MKBXSScanDeviceInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKBXSScanDeviceInfoCellIdenty"];
    if (!cell) {
        cell = [[MKBXSScanDeviceInfoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKBXSScanDeviceInfoCellIdenty"];
    }
    return cell;
}
...
- (void)connectButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(mk_bxs_connectPeripheral:)]) {
        [self.delegate mk_bxs_connectPeripheral:self.dataModel.peripheral];
    }
}

#pragma mark - setter
- (void)setDataModel:(MKBXSScanInfoCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKBXSScanInfoCellModel.class]) {
        return;
    }
...
- (UIImageView *)rssiIcon{
    if (!_rssiIcon) {
        ...
        _rssiIcon.image = LOADICON(@"MKBXPSeriesSlathf", @"MKBXSScanDeviceInfoCell", @"bxs_signalIcon.png");
    }
    return _rssiIcon;
}
...
- (UIImageView *)batteryIcon{
    if (!_batteryIcon) {
        ...
        _batteryIcon.image = LOADICON(@"MKBXPSeriesSlathf", @"MKBXSScanDeviceInfoCell", @"bxs_batteryHighest.png");
    }
    return _batteryIcon;
}
