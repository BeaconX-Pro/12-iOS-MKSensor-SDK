...
@implementation MKBXSTHCurveViewModel
...
@interface MKBXSCurveView : UIView
...
@interface MKBXSTHCurveView ()<UIScrollViewDelegate>
...
@property (nonatomic, strong)MKBXSCurveView *curveView;

@property (nonatomic, strong)UIScrollView *scrollView;

@end

@implementation MKBXSTHCurveView
...
- (void)drawCurveWithParamModel:(MKBXSTHCurveViewModel *)dataModel
...
- (void)drawCurveWithPointList:(NSArray <NSString *>*)pointList
                      maxValue:(CGFloat)maxValue
                      minValue:(CGFloat)minValue {
    MKBXSTHCurveViewModel *dataModel = [[MKBXSTHCurveViewModel alloc] init];
...
#pragma mark - private method
- (void)configParamsWithModel:(MKBXSTHCurveViewModel *)paramModel {
...
- (MKBXSCurveView *)curveView {
    if (!_curveView) {
        _curveView = [[MKBXSCurveView alloc] init];
    }
    return _curveView;
}
